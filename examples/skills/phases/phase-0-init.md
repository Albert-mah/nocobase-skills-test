...
- Per-page UX expectations from "用户关注" sections
...
**If workflows use a title prefix** (e.g. "CRM-客户编号"):
```
...
- Routes with non-matching titles (e.g. "客户管理" instead of "CRM") need manual `desktopRoutes:destroy`
