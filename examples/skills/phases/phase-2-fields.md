...
status(select: 新客户/跟进中/已签约/流失), industry(select: 科技/制造/金融/...),
source(select: 官网/转介绍/展会/...), city(string), address(textarea), remarks(textarea)
...
Show user: field summary, any missing relations found.
Ask: "字段验证完毕，准备开始做页面了吗？"
