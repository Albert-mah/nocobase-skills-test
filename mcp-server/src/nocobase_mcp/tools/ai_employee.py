...
def register_tools(mcp: FastMCP):
    ...
    def nb_create_ai_employee(
        ...
        Args:
            ...
            nickname: Display name, e.g. "资产管家"
            position: Job title, e.g. "资产管理专家"
        ...
        Example:
            nb_create_ai_employee("my-helper", "助手", "通用助手",
                "nocobase-001-male", "通用业务助手",
                "你是一个通用助手...", "你好！有什么需要帮忙的？",
        ...
        Args:
            ...
            employees_json: JSON array of employee configs. Each item:
                {"username": "am-asset-keeper", "tasks": [
                    {"title": "查询资产", "message": {"system": "...", "user": "..."}, "autoSend": false}
                ]}
    ...
    def nb_ai_button(
        ...
        Args:
            ...
            tasks_json: Optional JSON array of preset tasks:
                [{"title": "分析数据", "message": {"system": "...", "user": "..."}, "autoSend": false}]
